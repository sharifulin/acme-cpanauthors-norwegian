...
=head1 SYNOPSIS
    ...
    my @ids      = $authors->id;
    my @distros  = $authors->distributions("VIY");
    my $url      = $authors->avatar_url("DZHARIY");
    my $kwalitee = $authors->kwalitee("VTI");
    my $name     = $authors->name("PANOLEX");
...
If you are a Ukrainian CPAN author not listed here, please send us your ID/name
via email or RT so we can always keep this module up to date.

And if you aren't a Ukrainian CPAN author listed here, please send us your ID/name
via email or RT and we will remove your name.

=head1 CONTAINED AUTHORS

Now B<10> Ukrainian CPAN authors:
